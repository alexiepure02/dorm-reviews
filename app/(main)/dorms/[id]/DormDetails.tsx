  ...
  return (
    <>
      <div className="bg-background">
        <div className="container mx-auto flex flex-col items-center xl:items-start">
          <div className="w-full flex flex-col xl:flex-row justify-between gap-8 p-6 md:p-10 lg:p-14">
